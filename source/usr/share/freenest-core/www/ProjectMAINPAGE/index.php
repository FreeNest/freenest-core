...
<div id="topBar">
  ...
  <div id="container">
    <div id="logo">
      <img src="images/logo.png" alt="FreeNEST Project Platform" />
    </div>
    <div id="content">
      <h1 id="authed"></h1>
      <div id="news">
     ...
     <!--<div id="activity" class="menu">
        <ul>
          <li class="silver"><img src="images/online_icon.png" alt="" class="icon" /> Online users
            <ul class="peepList">
