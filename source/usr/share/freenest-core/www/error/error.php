...
// format message
if (isset($redirect_status_message[$redirect_status])) {
	$message = str_replace('%U%', $request_uri, $redirect_status_message[$redirect_status]);
} else {
	$message = "Wut happened?";
}

// redirect to main page if peeps are trying to access this directly
if ($redirect_status == 100 || $redirect_status == 0) {
...
<head>
	...
	<style>
		@font-face { font-family: Roboto; font-weight: normal; src: url(../graphics/Roboto-Regular.ttf) format("truetype"); }
		@font-face { font-family: Roboto; font-weight: bold; src: url(../graphics/Roboto-Bold.ttf) format("truetype"); }
		* {
...
<body>
	<div id="error">
		<h1>You've come too far from your nest</h1>
		<h2><?php echo "Error $_SERVER[REDIRECT_STATUS] $redirect_status_reason[$redirect_status]"; ?></h2>
		<p><?php echo $message; ?></p>
		<p>Get back to <a href="<?php echo "$server_url" ?>"><?php echo "$server_name"; ?></a></p>
	</div>
</body>
</html>
